...
logit_log <- read_csv(file.path(rds_files_path, "Data/team_unplayed_predictions_glm.csv")) %>%
...
rf_log <- read_csv(file.path(rds_files_path, "Data/team_unplayed_rf_predictions.csv")) %>%
...
mlp_log <- read_csv(file.path(rds_files_path, "Data/team_unplayed_mlp_predictions.csv")) %>%
